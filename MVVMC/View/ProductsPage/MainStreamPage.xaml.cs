...
using AplicativoPromotor.MVVMC.ViewModel.ProdutosPage.PropertiesItems;
...
public partial class MainStreamPage : ContentPage
{
    ...
    private List<ProductModel> mainStreamPageItems; // Substitua com o seu tipo de item
    ...
    public MainStreamPage()
    {
        ...
        mainStreamPageItems = new MainStream().Items;

        // Configure a ListView com a lista original
        ItensListView.ItemsSource = mainStreamPageItems;
        ...
        if (searchTerm == currentSearchTerm && currentSearchTerm != null)
        {
            ...
            switch (searchType)
            {
                case (int)SearchTypes.Nome:
                    searchResults = mainStreamPageItems
